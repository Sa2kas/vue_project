    ...
    <vuci-form uci-config="firewall">
      <a-tabs>
        ...
        <a-tab-pane key="zones" :tab="$t('firewall.Zones')" >
          <vuci-typed-section title="Zones" index=0 type="zone" :columns="zoneColumns" addremove :card="false" expanded>
            <template #name="{ s }">
        ...
        <a-tab-pane key="redirect" :tab="$t('firewall.Port Forwards')">
          <vuci-typed-section title="Ports" index=1 type="redirect" :columns="redirectColumns" addremove sortable :card="false" expanded>
            <template #name="{ s }">
        ...
        <a-tab-pane key="rules" :tab="$t('firewall.Traffic Rules')">
          <vuci-typed-section index=2 type="rule" :title="$t('firewall.Traffic Rules')" :columns="ruleColumns" addremove sortable :card="false" expanded>
            <template #name="{ s }">
              <vuci-form-item-input :uci-section="s" name="name"/>
            </template>
            <template #enabled="{ s }">
